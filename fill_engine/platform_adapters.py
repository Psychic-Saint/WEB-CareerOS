...
PLATFORM_ADAPTERS: dict[str, dict[str, Any]] = {
    ...
    "generic": {
        ...
        "requires_login": False,
        "auto_submit_safe": True,
        "escalation_threshold": 0.40,   # needs at least 2 of 5 key fields filled
        "field_map": {
            ...
            "phone":        ['input[type="tel"]', 'input[name*="phone" i]',
                             ...
                             'input[placeholder*="mobile" i]', 'input[autocomplete="tel"]'],
            "linkedin_url": ['input[name*="linkedin" i]', 'input[placeholder*="LinkedIn" i]',
                             'input[id*="linkedin" i]', 'input[placeholder*="linkedin.com" i]'],
        },
        "cv_upload_selector": 'input[type="file"]',
        "submit_selectors": [
            'button[type="submit"]',
